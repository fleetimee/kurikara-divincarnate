...
class MasterGroupMateriResponseModel {
    ...
    factory MasterGroupMateriResponseModel.fromRawJson(String str) => MasterGroupMateriResponseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory MasterGroupMateriResponseModel.fromJson(Map<String, dynamic> json) => MasterGroupMateriResponseModel(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        groupMateriCreateDate: json["group_materi_create_date"] == null ? null : DateTime.parse(json["group_materi_create_date"]),
        groupMateriUpdateBy: json["group_materi_update_by"],
        groupMateriUpdateDate: json["group_materi_update_date"] == null ? null : DateTime.parse(json["group_materi_update_date"]),
        groupMateriIsDelete: json["group_materi_is_delete"],
        reportReading: json["report_reading"] == null ? [] : List<ReportIng>.from(json["report_reading"]!.map((x) => ReportIng.fromJson(x))),
        reportSpeaking: json["report_speaking"] == null ? [] : List<ReportIng>.from(json["report_speaking"]!.map((x) => ReportIng.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "report_reading": reportReading == null ? [] : List<dynamic>.from(reportReading!.map((x) => x.toJson())),
        "report_speaking": reportSpeaking == null ? [] : List<dynamic>.from(reportSpeaking!.map((x) => x.toJson())),
    };
}
...
class ReportIng {
    ...
    factory ReportIng.fromRawJson(String str) => ReportIng.fromJson(json.decode(str));
...
final levelNameValues = EnumValues({
    "1A": LevelName.THE_1_A
});

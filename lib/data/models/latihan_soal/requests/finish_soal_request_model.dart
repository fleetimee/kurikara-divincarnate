...
class FinishSoalRequestModel {
  ...
  FinishSoalRequestModel copyWith({
    String? user_id,
    String? id_level,
  ...
  @override
  String toString() {
    return 'FinishSoalRequestModel(user_id: $user_id, id_level: $id_level, id_group_materi: $id_group_materi, id_lesson: $id_lesson, mode: $mode)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is FinishSoalRequestModel &&
